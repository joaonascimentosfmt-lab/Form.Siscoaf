...
def obter_situacoes(categoria: Optional[str] = None) -> List[SituacaoItem]:
    todas = [
        ...
        SituacaoItem(chave="cod_1371", codigo="1371", artigo="Art. 155-A, XVI", texto="Art. 155-A, XVI - envolvam lavratura ou utilização de instrumento de procuração que outorgue amplos poderes de administração de pessoa jurídica ou de gestão empresarial, de gerência de negócios ou de movimentação de conta bancária, de pagamento ou de natureza semelhante, especialmente quando conferidos em caráter irrevogável ou irretratável ou isento de prestação de contas, independentemente de se tratar, ou não, de procuração em causa própria ou por prazo indeterminado;", pontuacao=2, setor=SETOR_NOTAS),
        ...
        SituacaoItem(chave="cod_1376", codigo="1376", artigo="Art. 159", texto="Art. 159. O tabelião de protesto, ou seu oficial de cumprimento, comunicará à UIF, na forma do art. 151, II, qualquer operação que envolva pagamento ou recebimento em espécie, ou por título ao portador, de valor igual ou superior a R$ 100.000,00 (cem mil reais) ou ao equivalente em outra moeda, desde que perante o tabelião ou seu preposto.", pontuacao=2, setor=SETOR_PROTESTO),
        SituacaoItem(chave="cod_1377", codigo="1377", artigo="Art. 160, I", texto="Art. 160, I - em valor igual ou superior a R$ 100.000,00 (cem mil reais), quando o devedor for pessoa física;", pontuacao=2, setor=SETOR_PROTESTO),
        SituacaoItem(chave="cod_1378", codigo="1378", artigo="Art. 160, II", texto="Art. 160, II - em valor igual ou superior a R$ 500.000,00 (quinhentos mil reais), quando o devedor for pessoa jurídica, salvo quando se tratar de instituição do mercado financeiro, do mercado de capitais ou de órgãos e entes públicos.", pontuacao=2, setor=SETOR_PROTESTO),
        SituacaoItem(chave="cod_1379", codigo="1379", artigo="Art. 161", texto="Art. 161. O oficial de registro de imóveis, ou seu oficial de cumprimento, comunicará à UIF, na forma do art. 151, II, registro de documento ou título em que conste declaração das partes de que foi realizado pagamento em espécie, ou por título ao portador, de valor igual ou superior a R$ 100.000,00 (cem mil reais) ou ao equivalente em outra moeda.", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1380", codigo="1380", artigo="Art. 162, I", texto="Art. 162, I - doações de bens imóveis ou direitos reais sobre bens imóveis para terceiros sem vínculo familiar aparente com o doador, referente a bem imóvel que tenha valor venal atribuído pelo município igual ou superior a R$ 100.000,00 (cem mil reais);", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1381", codigo="1381", artigo="Art. 162, II", texto="Art. 162, II - concessão de empréstimos hipotecários ou com alienação fiduciária entre particulares;", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1382", codigo="1382", artigo="Art. 162, III", texto="Art. 162, III - registro de negócios celebrados por sociedades que tenham sido dissolvidas e tenham regressado à atividade;", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1383", codigo="1383", artigo="Art. 162, IV", texto="Art. 162, IV - registro de aquisição de imóveis por fundações e associações, quando as características do negócio não se coadunem com suas finalidades;", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1384", codigo="1384", artigo="Art. 162, V", texto="Art. 162, V - registro de transmissões sucessivas do mesmo bem em período e com diferença de valor anormais;", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1385", codigo="1385", artigo="Art. 162, VI", texto="Art. 162, VI - registro de título no qual conste valor declarado de bem com diferença anormal em relação a outros valores a ele associados, como o de sua avaliação fiscal ou o valor patrimonial pelo qual tenha sido considerado para fins sucessórios ou de integralização de capital de sociedade, por exemplo.", pontuacao=2, setor=SETOR_IMOVEIS),
        SituacaoItem(chave="cod_1386", codigo="1386", artigo="Art. 163", texto="Art. 163. O oficial de registro de títulos e documentos e de registro civil das pessoas jurídicas, ou seu oficial de cumprimento, comunicará à UIF, na forma do art. 151, II, qualquer operação que envolva pagamento ou recebimento em espécie, ou por título ao portador, de valor igual ou superior a R$ 100.000,00 (cem mil reais) ou ao equivalente em outra moeda, inclusive quando se relacionar à compra ou venda de bens móveis ou imóveis.", pontuacao=2, setor=SETOR_RCPJ),
        SituacaoItem(chave="cod_1387", codigo="1387", artigo="Art. 164, I", texto="Art. 164, I - transferências de bens imóveis de qualquer valor, de cotas ou participações societárias ou de bens móveis de valor superior a R$ 100.000,00 (cem mil reais);", pontuacao=2, setor=SETOR_RCPJ),
        SituacaoItem(chave="cod_1388", codigo="1388", artigo="Art. 164, II", texto="Art. 164, II - mútuos concedidos ou contraídos ou doações concedidas ou recebidas de valor superior ao equivalente a R$ 100.000,00 (cem mil reais);", pontuacao=2, setor=SETOR_RCPJ),
        SituacaoItem(chave="cod_1389", codigo="1389", artigo="Art. 164, III", texto="Art. 164, III - participações, investimentos ou representações de pessoas naturais ou jurídicas brasileiras em entidades estrangeiras, especialmente trusts, arranjos semelhantes ou fundações;", pontuacao=2, setor=SETOR_RCPJ),
        SituacaoItem(chave="cod_1390", codigo="1390", artigo="Art. 164, IV", texto="Art. 164, IV - cessão de direito de títulos de créditos ou de títulos públicos de valor igual ou superior a R$ 500.000,00 (quinhentos mil reais).", pontuacao=2, setor=SETOR_RCPJ),
        SituacaoItem(chave="cod_1391", codigo="1391", artigo="Art. 171", texto="Art. 171. O tabelião de notas, ou seu oficial de cumprimento, comunicará à UIF, na forma do art. 151, II, qualquer operação que envolva pagamento ou recebimento em espécie, ou por título ao portador, de valor igual ou superior a R$ 100.000,00 (cem mil reais) ou ao equivalente em outra moeda, inclusive quando se relacionar à compra ou venda de bens móveis ou imóveis.", pontuacao=2, setor=SETOR_NOTAS),
        SituacaoItem(chave="cod_1392", codigo="1392", artigo="Art. 172 c/c art. 162, I", texto="Art. 172 c/c art. 162, I: Art. 172. O tabelião de notas, ou seu oficial de cumprimento, deve analisar com especial atenção, para fins de eventual comunicação à UIF na forma do art. 151, I, operações, propostas de operação ou situações relacionadas a quaisquer das hipóteses listadas no art. 162, quando envolverem escritura pública. Art. 162. [...] I - doações de bens imóveis ou direitos reais sobre bens imóveis para terceiros sem vínculo familiar aparente com o doador, referente a bem imóvel que tenha valor venal atribuído pelo município igual ou superior a R$ 100.000,00 (cem mil reais);", pontuacao=2, setor=SETOR_NOTAS),
        SituacaoItem(chave="cod_1393", codigo="1393", artigo="Art. 172 c/c art. 162, II", texto="Art. 172 c/c art. 162, II: Art. 172. O tabelião de notas, ou seu oficial de cumprimento, deve analisar com especial atenção, para fins de eventual comunicação à UIF na forma do art. 151, I, operações, propostas de operação ou situações relacionadas a quaisquer das hipóteses listadas no art. 162, quando envolverem escritura pública. Art. 162. [...] II - concessão de empréstimos hipotecários ou com alienação fiduciária entre particulares;", pontuacao=2, setor=SETOR_NOTAS),
